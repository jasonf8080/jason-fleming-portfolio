...
const Contact = () => {
  ...
  // Netlify docs-style submit (React version)
  ...
  useGSAP(() => {
    ...
    timeline.from(["#contact-title", "#contact p", "#contact .text-underline"], {
      opacity: 0,
      xPercent: -100,
    });

    timeline.from("#contact-title span", { opacity: 0, x: -50, y: 50 });

    timeline.from("#message-form > *", {
      opacity: 0,
      yPercent: -100,
      stagger: { amount: 0.3 },
    });
    ...
    <section ref={sectionRef} id="contact" className="bg-[#1a1a1a] py-16 md:py-25">
      <div className="container">
        ...
        <div className="flex flex-col md:flex-row gap-16 md:gap-24 mt-12">
          ...
          >
            {/* Include this so Netlify can reliably identify the form-name */}
            ...
            <button
              type="submit"
              className="bg-[#333] rounded-sm uppercase font-bold py-3 px-6"
